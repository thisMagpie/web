	...
	?>
				...
				<header class="entry-header">
					...
					<div class="entry-meta">
						...
						<span class="full-size-link">
						    ...
						    <?php echo $metadata['width']; ?> &times; <?php echo $metadata['height']; ?></a>
					    </span>
			...
			<nav id="image-navigation" class="navigation image-navigation">
				...
				<?php previous_image_link( false,
				                           '<div class="previous-image">' . __( 'Previous Image', 'magpie' ) . '</div>' ); ?>
				<?php next_image_link( false, '<div class="next-image">' . __( 'Next Image', 'magpie' ) . '</div>' ); ?>
				</div><!-- .nav-links -->
